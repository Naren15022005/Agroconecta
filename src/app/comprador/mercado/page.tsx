        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center">
            ...
            <p className="text-green-100 mb-6 max-w-2xl mx-auto text-lg">
              Encuentra productos frescos directamente de agricultores colombianos
            </p>
          ...
          <div className="mb-4 sm:mb-0">
            <div className="flex items-center gap-4">
              <div>
                ...
                <p className="text-gray-600">Explora y compra productos frescos directamente de agricultores colombianos</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <a href="/comprador/mercado" className="block text-gray-600 hover:text-green-600 transition-colors">Explorar mercado</a>
                <a href="/comprador/pedidos" className="block text-gray-600 hover:text-green-600 transition-colors">Mis pedidos</a>
                <a href="/comprador/perfil" className="block text-gray-600 hover:text-green-600 transition-colors">Mi perfil</a>
              </div>
            </div>
            <div>
